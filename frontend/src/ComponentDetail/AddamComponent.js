...
function AddamComponent() {
  const [data, setData] = useState([]);

  const movie_name = 'Addam Family';
  useEffect(() => {
    axios.get(`http://localhost:8080/Kids/${encodeURIComponent(movie_name)}`).then((response) => {
